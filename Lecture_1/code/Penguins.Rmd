...
# Here your code
ggplot() +
  geom_point(data = penguins, aes(x = flipper_length_mm, y = bill_length_mm, colour = species, shape = sex))
```
...
ggplot(penguins, aes(x = flipper_length_mm,
                     ...
                     colour = species,
                     shape = sex)) +
       labs(title = "Correlation between flipper length and bill length",
            subtitle = "Plot by Chris",
            x = "Flipper length",
            y = "Bill length",
...
ggplot(penguins, aes(x = species,
  ...
  geom_boxplot() +
  facet_wrap(~ island) +
  scale_fill_manual(values = c("#DA020E", "mediumblue"))
